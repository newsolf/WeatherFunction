...
public interface WeatherService {
    ...
    suspend fun getWeatherLive(@Path("cityId") cityId: String): BaseResponse<DetailBean>
    ...
    suspend fun getWeatherForecast(@Path("cityId") cityId: String): BaseResponse<SevenDay>
